...
FlowRouter.route('/about/aboutUs/', generateRoute('aboutUs', 'aboutYouTripTpl'));

FlowRouter.route('/about/FAQ/', generateRoute('faq', 'faqTpl'));

FlowRouter.route('/help/PolitiqueConfidentialite/', generateRoute('politique_confidentialite', 'politique_confidentialiteTpl'));

FlowRouter.route('/help/ConditionsGenerales/', generateRoute('cgu', 'cguTpl'));

FlowRouter.route('/about/contactUs/', generateRoute('contactUs', 'contactUsTpl'));
/*
